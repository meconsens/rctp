...
```{r echo=FALSE, cache=FALSE, comment=FALSE, warning=FALSE}
marker_lists <- c("in_ex_CgG","subclass_CgG", "subclass_MTG", "subclass_both_CgG", "subclass_both_MTG", "lake", "darmanis")
for(markers in marker_lists){
    print(markers)
    setwd('./commonMarkerLists')
...
Now that we've Z scored all the MGPs, we can move onto our mega-analysis.
=======
---
title: "MGP Calculation (rCTP derivation)"
output:
