...
cohorts <- c("ROSMAP", "MAYO", "BM10", "BM22", "BM36", "BM44")
#marker_lists <- c("subclass_MTGCgG_derived_common_final", "in_ex_CgG_common_final","subclass_CgG_common_final", "subclass_MTG_common_final","subclass_both_common_final", "lake", "darmanis")
marker_lists <- c("subclass_MTGCgG_derived_common_final")
setwd('./geneAnno')
gene_anno <- readRDS("gene_anno.rds")
setwd('../')
