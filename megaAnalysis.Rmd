...
```{r}
marker_lists <- c("subclass_new_no_SST", "subclass_new_common_final","subclass_MTGCgG_derived_no_SST","subclass_MTGCgG_derived_common_final","in_ex_CgG_common_final","subclass_CgG_common_final", "subclass_MTG_common_final", "subclass_both_CgG_common_final", "subclass_both_MTG_common_final", "lake", "darmanis")
...
marker_lists <- c("subclass_new_no_SST", "subclass_new_common_final", "subclass_MTGCgG_derived_no_SST","subclass_MTGCgG_derived_common_final","in_ex_CgG_common_final","subclass_CgG_common_final", "subclass_MTG_common_final","subclass_both", "lake", "darmanis")
setwd('./rawCohortData')
...
```{r}
marker_lists <- c("subclass_new_no_SST", "subclass_new_common_final", "subclass_MTGCgG_derived_no_SST","subclass_MTGCgG_derived_common_final", "in_ex_CgG_common_final","subclass_CgG_common_final", "subclass_MTG_common_final","subclass_both", "subclass_both_pre", "subclass_both_temp", "lake", "darmanis")
...
```{r}
cohorts <- c("ROSMAP", "MAYO", "BM10", "BM22", "BM36", "BM44")
marker_lists <- c("subclass_new_no_SST", "subclass_new_common_final","subclass_MTGCgG_derived_common_final","in_ex_CgG_common_final","subclass_CgG_common_final", "subclass_MTG_common_final","subclass_both", "lake", "darmanis")
...
```{r}
marker_lists <- c("subclass_new_no_SST", "subclass_new_common_final","subclass_MTGCgG_derived_common_final", "in_ex_CgG_common_final","subclass_CgG_common_final", "subclass_MTG_common_final","subclass_both", "subclass_both_pre", "subclass_both_temp", "lake", "darmanis")
for(markers in marker_lists){
  print(markers)
  folder_name <- gsub('_common_final', '', markers)
  if(markers == "subclass_both_pre" | markers == "subclass_both_temp"){
...
full_plot_temp = plot_grid(mega_analysis_plot_subclass_both_temp, 
                          ...
                          rel_heights = c(1.5,2.5), labels = c('A'))
setwd('./figures')
saveRDS(full_plot_pre, "PREFRONTAL-figure1.rds")
pdf(file = "PREFRONTAL-figure1.pdf", 
    width = 10, # The width of the plot in inches
    height = 12)
print(full_plot_pre)
dev.off()
saveRDS(full_plot_temp, "TEMPORAL-figure2.rds")
pdf(file = "TEMPORAL-figure2.pdf", 
    width = 10, # The width of the plot in inches
    height = 12)
...
subclass_meta <- read.csv('subclass_meta.txt')
setwd('../')
markers <- "subclass_MTGCgG_derived_common_final"
folder_name <- "subclass_MTGCgG_derived"
setwd(paste0('./mgpResults_',folder_name))
full_res <- readRDS(paste0("full_res_", markers, ".rds"))
assign(paste0("full_res_", "markers"), full_res)
full_sig <- readRDS(paste0("full_sig_", markers, ".rds"))
...
## generate the final multi-panel temporal figure using cowplot's plot_grid
bottom_plot = plot_grid(SST_final_boxplots_subclass_MTGCgG_derived_common_final, 
                    IT_final_boxplots_subclass_MTGCgG_derived_common_final,  
                    nrow = 2, ncol = 1, rel_widths = c(.6, .4), 
                    axis = 'l', align = 'v', labels = c('B', 'C'))
full_plot = plot_grid(mega_analysis_plot_subclass_MTGCgG_derived_common_final, 
                          bottom_plot, nrow = 2 , 
                          rel_heights = c(1.5,2.5), labels = c('A'))
setwd('./figures')
