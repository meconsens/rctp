...
```{r}
marker_lists <- c("subclass_MTGCgG_derived_no_SST","subclass_MTGCgG_derived_common_final","in_ex_CgG_common_final","subclass_CgG_common_final", "subclass_MTG_common_final", "subclass_both_CgG_common_final", "subclass_both_MTG_common_final", "lake", "darmanis")
...
marker_lists <- c("subclass_MTGCgG_derived_no_SST","subclass_MTGCgG_derived_common_final","in_ex_CgG_common_final","subclass_CgG_common_final", "subclass_MTG_common_final","subclass_both", "lake", "darmanis")
setwd('./rawCohortData')
...
```{r}
marker_lists <- c("subclass_MTGCgG_derived_no_SST","subclass_MTGCgG_derived_common_final", "in_ex_CgG_common_final","subclass_CgG_common_final", "subclass_MTG_common_final","subclass_both", "subclass_both_pre", "subclass_both_temp", "lake", "darmanis")
...
```{r}
marker_lists <- c("subclass_MTGCgG_derived_common_final", "in_ex_CgG_common_final","subclass_CgG_common_final", "subclass_MTG_common_final","subclass_both", "subclass_both_pre", "subclass_both_temp", "lake", "darmanis")
for(markers in marker_lists){
  print(markers)
  folder_name <- gsub('_common_final', '', markers)
  if(markers == "subclass_both_pre" | markers == "subclass_both_temp"){
