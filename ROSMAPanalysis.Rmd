...
heatmap <- ggplot(results, aes(celltype, pathology, fill= signedFDR))+
  ...
  geom_text(data=subset(sig_res), aes(label=formatC(fdr, format = "e", digits = 2), label.size=0.1), color ="white") +
  theme_minimal() +                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
...
heatmap <- ggplot(results, aes(celltype, pathology, fill= signedFDR))+
  ...
  facet_grid(~AIBS_class_label, scale = 'free_x', space = 'free_x') +
  scale_fill_gradient2(low="darkblue", high="darkgreen", guide="colorbar") + 
  geom_text(data=subset(sig_res,fdr<0.05), aes(label=format(round(fdr*100, 2))), color ="white") +
  theme_minimal() +
  theme(axis.title.y=element_blank(),
        axis.title.x=element_blank(),
        axis.ticks.y=element_blank(),
